...
import { Download, ArrowUpRight, Zap, PlayCircle, CheckCircle2 } from 'lucide-react';
...
const ActionCards = () => {
  ...
  return (
    ...
    >
      {isInstalled ? (
        /* Affichage quand l'app est DÉJÀ installée */
        <motion.div
          variants={item}
          className="relative overflow-hidden rounded-[2rem] bg-emerald-500/10 border border-emerald-500/20 p-8 text-center"
        >
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="space-y-2">
              <h3 className="text-xl font-black text-white uppercase italic tracking-tight">Application Active</h3>
              <p className="text-[10px] text-emerald-400/70 font-black uppercase tracking-[0.2em]">
                Vous utilisez la version optimisée
              </p>
            </div>
          </div>
        </motion.div>
      ) : (
        /* Affichage standard pour l'installation */
        <>
          <motion.a
            variants={item}
