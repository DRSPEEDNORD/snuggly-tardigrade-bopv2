...
const Header = () => {
  return (
    <header className="w-full pt-20 pb-12 px-6 flex flex-col items-center text-center relative">
      ...
      <div className="relative mb-12">
        ...
        <div className="relative w-40 h-40 rounded-full p-[3px] bg-gradient-to-b from-emerald-500 via-emerald-500/20 to-transparent shadow-[0_0_50px_rgba(16,185,129,0.2)]">
          <div className="w-full h-full rounded-full overflow-hidden bg-[#010402] flex items-center justify-center border border-white/10">
            <img 
              ...
              onError={(e) => {
                ...
                if (parent) {
                  parent.innerHTML = '<span class="text-5xl font-black text-emerald-400 italic glow-emerald">DSN</span>';
                }
              }}
            />
          </div>
      ...
      <div className="space-y-4 relative z-10">
        <div className="relative">
          <h2 className="text-6xl font-black italic tracking-tighter text-outline absolute -top-4 left-1/2 -translate-x-1/2 opacity-20 select-none">
            DR SPEED
          </h2>
          <h1 className="text-5xl font-black italic tracking-tighter text-white uppercase leading-none relative">
            DR SPEED <span className="text-emerald-400 glow-emerald">NORD</span>
          </h1>
        </div>
