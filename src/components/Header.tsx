  ...
  return (
    <div className="w-full pt-6 pb-4 px-4 flex flex-col items-center gap-4">
      ...
      <div className="relative">
        <div className="w-28 h-28 rounded-full border-2 border-purple-500/50 p-1 shadow-[0_0_30px_rgba(168,85,247,0.3)]">
        ...
        <div className="absolute bottom-1 right-2 w-5 h-5 bg-green-500 border-4 border-[#0B0B12] rounded-full shadow-lg"></div>
      </div>
      ...
      <div className="text-center">
        ...
        <p className="text-gray-500 text-xs mt-1 flex items-center justify-center gap-2 font-medium tracking-widest uppercase">
